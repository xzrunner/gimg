...
uint8_t* gimg_etc2_decode_rgba4(const uint8_t* buf, int width, int height, int type);
uint8_t* gimg_etc2_decode_rgba8(const uint8_t* buf, int width, int height, int type);
